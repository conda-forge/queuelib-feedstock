...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/queuelib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9561&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/queuelib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `queuelib` can be installed with:

```
conda install queuelib
```

It is possible to list all of the versions of `queuelib` available on your platform with:
